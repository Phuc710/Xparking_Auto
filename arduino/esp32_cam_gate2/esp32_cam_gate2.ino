/**
 * ESP32_CAM_GATE2 - Camera cho XPARKING Gate 2
...
const char* T_TRIGGER = "xparking/gate2/cam/trigger";
const char* T_IMAGE = "xparking/gate2/cam/image";
const char* T_STATUS = "xparking/gate2/cam/status";
...
void reconnect() {
  while (!mqtt.connected()) {
    Serial.print("MQTT...");
    String id = "CAM_GATE2_" + String(random(0xffff), HEX);
